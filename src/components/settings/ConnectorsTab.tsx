...
export function ConnectorsTab({
  ...
  const connectorCatalog = useMemo(
    () => [
      ...
      },
      {
        id: "spotify",
        title: "Spotify",
        summary: "Requires an active Spotify Premium subscription.",
    ...
    [handleDisconnectWorkspace, loginWithWorkspace, workspaceAuth],
  );
  ...
  const connectedRows = [
    ...
    },
    {
      ...
      title: "Spotify",
      icon: <SpotifyIcon className="h-5 w-5 text-[#1DB954]" />,
      subtitle: spotifyAuth ? "Music tools are active — disconnect when ready." : "Requires Spotify Premium.",
      metric: spotifyAuth ? "1 connector" : "Unavailable",
      action: spotifyAuth ? handleDisconnectSpotify : null,
